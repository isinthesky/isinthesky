...
## 4. 아키텍처 및 MSA 환경에서의 AI 활용

### A. 더욱더 중요해지는 아키텍쳐, 그리고 문서(Cluade.md, CursorAI MDC)
...
- user.CLAUDE.md(개인 설정)
  - 한국어 답변
  - 개인 코딩 스타일
  - ex) 도구 결과를 받은 후에는 그 품질을 신중하게 검토하고, 최적의 다음 단계를 결정한 뒤 진행하세요. 새로운 정보를 바탕으로 계획하고 반복하며, 가장 적절한 조치를 취하세요.
...
- root/CLAUDE.md
  - 프로젝트 개요, 목표, 아키텍쳐
- root/src/CLAUDE.md
  - 아키텍처 상세(레이어 역할분리, 도메인 관심사), 명명 규칙
